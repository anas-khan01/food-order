                ...
                while($row=mysqli_fetch_assoc($res2))
                {
                    ...
                    <div class="food-menu-box">
                        <div class="food-menu-img">
                            <?php 
                                ...
                                else
                                {
                                    //Image Available
                                    ?>
                                    <img src="<?php echo SITEURL; ?>images/food/<?php echo $image_name; ?>" alt="Chicke Hawain Pizza" class="img-responsive img-curve" width="100px" height="80px">
                                    <?php
                                }
                            ?>
                        ...
                        <div class="food-menu-desc">
                            ...
                            <a href="<?php echo SITEURL; ?>order.php?food_Id=<?php echo $id; ?>" class="btn btn-prim">Order Now</a>
                        </div>
                    </div>
